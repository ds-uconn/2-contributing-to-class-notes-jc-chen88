...
Alternatively, You can go to the fork on Github and click on Code -> Local -> SSH
and copy paste the SSH key into the command line after typing in `git clone`.
...
Once the commit is made, use the following command to push the commits to Github:
